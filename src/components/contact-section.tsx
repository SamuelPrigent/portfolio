    ...
    <section className="mx-auto mb-3 mt-16 max-w-3xl px-6 pt-20">
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-md border border-border px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:text-foreground dark:text-muted-foreground"
        >
