...
export default function PresentationLeft() {
  return (
    <div className="presentationContainerLeft relative my-auto flex flex-col rounded-lg pt-[70px] text-start font-bold max-lg:pt-[60px] ">
      <img
        className="presentationUnderline absolute left-[230px] top-[127px] rotate-[-2deg] max-lg:left-[300px] max-lg:top-[122px] max-md:left-[57%] max-md:top-[117px] max-sm:left-[54%] max-sm:top-[107px] max-sm:h-[12px] lg:w-[175px]"
        src={underline}
        height={30}
        width={195}
        alt="img underline"
      ...
      <div
        id="name"
        className="gradientText z-10 mb-[5px] text-[47px] leading-tight max-lg:text-center max-md:text-[45px] max-sm:text-[35px]"
      >
        Samuel Prigent
      </div>
      <div
        id="developpeur"
        className="z-10 font-poppins text-[75px] font-semibold leading-tight text-white max-lg:text-center max-lg:text-[60px] max-md:text-[55px] max-sm:text-[45px]"
      >
        Developpeur
      </div>
      <div
        id="fullstack"
        className="voidTextWithBordure z-10 font-poppins text-[100px] font-semibold leading-none max-lg:text-center max-lg:text-[70px] max-md:text-[60px] max-sm:text-[50px]"
      >
        Fullstack
      </div>
