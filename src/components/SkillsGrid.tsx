...
export default function SkillsGrid() {
  return (
    <>
      {/* grid */}
      <div className="grid grid-cols-2 gap-4 pt-[15px] max-lg:grid-cols-2 max-sm:grid-cols-1">
        {/* react */}
        <SkillCard>
        ...
        {/* Style */}
        <SkillCard>
          <div className="growThis styleGradient flex h-[120px] w-full items-center justify-center gap-[25px] rounded-lg  brightness-150 saturate-0">
            <BlackOverlay></BlackOverlay>
            <img
        ...
        {/* Testing */}
        <SkillCard>
          <div className="growThis relative flex h-[120px] w-full justify-center overflow-hidden rounded-lg brightness-150 saturate-0">
            <BlackOverlay></BlackOverlay>
